...
*/}}
{{- define "cloudflare-tunnel-operator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "cloudflare-tunnel-operator.resourceName" -}}
{{- $fullname := include "cloudflare-tunnel-operator.fullname" .context }}
{{- $suffix := .suffix }}
...
{{- else }}
{{- include "cloudflare-tunnel-operator.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
